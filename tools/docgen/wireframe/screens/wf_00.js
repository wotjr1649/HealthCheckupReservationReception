...
const desc = [
  ...
  { n: '1', text: '업무 진입점 4개. 예약 관리·접수 관리는 같은 Tab을 공유 (§1.1)' },
  { n: '2', text: 'Ribbon Group 순서는 검색 → 현재 업무 Action → 보기 (§4.2)' },
  { n: '3', text: '동일 업무 Tab은 중복 생성하지 않는다 (Single Instance, §4.3)' },
  { n: '4', text: '주요 Action은 하단이 아니라 Context Ribbon에 둔다 (§4.2)' },
