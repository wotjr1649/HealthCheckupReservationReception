...
const desc = [
  ...
  { n: '', text: '그림은 New Mode 기준. Edit Mode는 자동발급 전환 없이 기존 차트번호 수동수정만 허용한다.' },
  { n: '1', text: 'New는 자동발급이 기본값. Edit에서는 이 선택이 없다' },
  { n: '2', text: '자동발급 번호는 화면 진입 시 점유하지 않고 저장 Transaction에서 확정' },
  { n: '3', text: '이름·주민등록번호가 필수. 미입력이면 저장 비활성 (EP-04)' },
  { n: '4', text: '전체값 표시. `-` 제거 후 숫자 13자리로 정규화하여 저장' },
