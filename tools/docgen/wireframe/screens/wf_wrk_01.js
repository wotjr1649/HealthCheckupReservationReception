...
const desc = [
  ...
  { n: '', text: '예약 Context는 [현장 당일예약]·[추가검사변경]·[접수취소] 없이 [예약취소]가 대신 있다. [변경이력]은 두 Context 공통이며 상태와 무관하게 행이 선택되면 열린다. 공통 업무불가는 Action을 닫지 않는다. 상태별 활성/비활성은 부록 D 참조. 접수 Context 미선택 상태에서 활성인 것은 [조회]·[컬럼설정]·[현장 당일예약]뿐이다.' },
