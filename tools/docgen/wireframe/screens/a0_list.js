...
const LEGEND = [
  ...
  ['화면 용어', 'PatientId 수검자 Master 내부 식별자   ·   WorkId 예약/접수 업무 1건의 식별자   ·   Normal 일반 신규예약 Context   ·   WalkIn 현장 당일예약 Context(예약일 = 오늘 고정 ReadOnly)   ·   RowVersion / LastEditDate 저장 시 함께 전달하는 동시성값'],
  ...
  ['공통 업무조건', '휴무일이거나 운영시간(09:00~18:00) 밖이면 모든 화면의 업무 Action을 비활성한다. 화면 표시는 안내값이며 저장 성공을 보장하지 않는다. (CP-01~04)'],
  ['구현 제외', '로그인·권한, 통계 Dashboard, 실제 검사 수행·결과 입력·판독, 공단 대상자 API, 휴무일·검사 Master·AEX 관리자 CRUD, 가격·할인·수납·결제, 수검자 삭제·복원, 출력·인쇄·엑셀 내보내기, 사용자별 Grid Layout 저장.'],
];
