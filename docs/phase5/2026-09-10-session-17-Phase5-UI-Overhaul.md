...
5. WF-RSV-01 을 모달로 (§4.6 1·2번)
   화면 ID 는 WF-RSV-01 그대로다. Presenter · Service · Repository · 시험은 그대로 가고
   Designer 와 MainForm 배선만 바뀐다. 리본 [신규 예약] Page 는 그룹 없는 진입 Page 가 된다
