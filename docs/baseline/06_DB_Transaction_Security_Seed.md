...
- **문서 버전:** v1.14  (`[R12]` 회차별 버전을 여기 적지 않는다 — §4.1 표가 단일 출처이고 무엇을 고쳤는지는 아래 `RN 개정 범위` 가 적는다. 걷어낸 사본은 R6 부터 한 칸씩 밀려 있었고 아무 게이트도 그것을 보지 않았다. ROOT `AGENTS.md` §6)
...
| `05_DB_Rule_SP_Contract.md` | v3.8 | FINAL / GO / READ-ONLY | `HC-RSV-RCP-20260910-R17` |
| `06_DB_Transaction_Security_Seed.md` | v1.14 | FINAL / GO / READ-ONLY | `HC-RSV-RCP-20260910-R17` |
