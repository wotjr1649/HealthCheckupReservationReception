...
- **문서 버전:** v1.8  (v1.0 → R4 한글화 반영. v1.1 → R5 에서 §42 Gate 세 칸을 실측에 맞췄다. v1.2 → R6 에서 §42 의 미래 단정 한 줄을 걷었다. v1.3 → R7 계약 재설계. v1.4 → R8 리뷰 정정. v1.5 → R9 Seed 건수 사본 제거. v1.6 → R10 §4.1 회차 갱신. v1.7 → R11 §4.1 회차 갱신)
- **기준일:** 2026-09-08  ·  **실행검증일:** 2026-09-07(R3 회귀) · 2026-09-08(R4 회귀 · R5 회귀 회차 `C`)
- **기준선 ID:** `HC-RSV-RCP-20260909-R11`  (직전 `HC-RSV-RCP-20260909-R10`)
...
| `03_Wireframe_Definition.md` | v1.7 | FINAL / GO / READ-ONLY | `HC-RSV-RCP-20260909-R11` |
| `04_DB_Design.md` | v3.3 | FINAL / GO / READ-ONLY | `HC-RSV-RCP-20260908-R8` |
| `05_DB_Rule_SP_Contract.md` | v3.3 | FINAL / GO / READ-ONLY | `HC-RSV-RCP-20260909-R11` |
| `06_DB_Transaction_Security_Seed.md` | v1.8 | FINAL / GO / READ-ONLY | `HC-RSV-RCP-20260909-R11` |
...
`04` 는 R8, `00`·`02` 는 R7 표기를 유지한다 — 열지 않은 문서는 회차가 올라가지 않는다 (ROOT `AGENTS.md` §2.2).
