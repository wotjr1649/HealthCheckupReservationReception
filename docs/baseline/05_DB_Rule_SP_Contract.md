...
- **문서 버전:** v3.3
- **기준일:** 2026-09-08
- **기준선 ID:** `HC-RSV-RCP-20260909-R11`
- **직전 기준선:** `HC-RSV-RCP-20260908-R8` (2026-09-08, v3.2)
...
| UPDATE_수검자정보 | 0, 1, 100~102, 200~201, 204~205, 601, 308~309 |
...
> **최종 판정: FINAL / GO / READ-ONLY — Rule·Stored Procedure 계약이 완결되었다. `HC-RSV-RCP-20260908-R7` 기준선이며, 개정은 재봉인 절차(ROOT `AGENTS.md` §2.2)로만 한다.**
