...
| 회차 | 시각 | 업무시간 | 결과 |
|---|---|---|---|
| `A` 창 안 | 2026-09-07 12:26 | 안 (월, 비휴무일 · PM 창 11:10~15:50) | `artifacts/logs/full_test_run.log` — exit 0 · PASS 354 · FAIL 0 · SKIP 2 · NOT RUN 1 |
| `B` 창 밖 | 2026-09-08 02:17 | 밖 | `artifacts/logs/full_test_run_off.log` — exit 0 · PASS 182 · FAIL 0 · SKIP 78 · NOT RUN 9 |
